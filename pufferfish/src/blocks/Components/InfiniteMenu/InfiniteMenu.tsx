...
void main() {
    ...
    // Assume most images are landscape (16:9 or similar)
    // For landscape images, we want to crop the sides and show center
    float cropFactor = 0.7; // Show only center 70% of width
    
    // Crop horizontally from center
    st.x = (st.x - 0.5) * cropFactor + 0.5;
    
    // Clamp to ensure we stay within bounds
    st = clamp(st, 0.0, 1.0);
    
    // Apply cell offset for atlas
    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 pointer-events-none">
                {/* Title - Left Side (Desktop) / Top (Mobile) */}
                {activeItem && (
                    <div
                        className={`
                        ...
                        ${
                            isMobile
                                ? "top-30 left-1/2 transform -translate-x-1/2 text-center"
                                : "left-0 top-1/2 transform -translate-y-1/2 text-left"
                        }
                        p-4 md:p-6 lg:p-8
                    `}
                    >
                            ...
                            className={`
                                ...
                                ${
                                    isMobile
                                        ...
                                        : "text-4xl lg:text-5xl xl:[font-size:4rem]"
                                }
                                ${
                                    isMobile
                                        ? "max-w-none w-screen"
                ...
                {/* Description - Right Side (Desktop) / Bottom (Mobile) */}
                {activeItem && (
                    <div
                        className={`
                        absolute pointer-events-auto
                            ...
                            className={`
                                ...
                                ${
                                    isMobile
                                        ...
                                        : "text-lg lg:text-xl xl:text-[1.5rem]"
                                }
                                ${
                                    isMobile
                                        ? "max-w-[80vw]"
                ...
                {activeItem && (
                    ...
                    `}>
                        ...
                        >
                            <p
                                className={`select-none relative text-[#060010] top-[2px] ${
